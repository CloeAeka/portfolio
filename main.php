...
<body>
    ...
    <header>
    <svg id="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 633.99 136.86">
        <defs>
            <style>.cls-1{fill:none;stroke:#fff;stroke-miterlimit:10;stroke-width:4px;}</style>
        </defs><g id="Calque_2" data-name="Calque 2">
            <path class="cls-1 letter" d="M2,12A183.07,183.07,0,0,1,32.31,9.62c15.61,0,27,3.63,34.3,10.17,6.72,5.81,10.71,14.7,10.71,25.59,0,11.07-3.26,19.78-9.43,26.14C59.54,80.41,45.92,85,30.5,85a54.25,54.25,0,0,1-12.71-1.09v49H2ZM17.79,71a52.88,52.88,0,0,0,13.07,1.27c19.06,0,30.67-9.26,30.67-26.14,0-16.15-11.43-24-28.86-24-6.89,0-12.16.54-14.88,1.27Z"/>
            <path class="cls-1" d="M173,88.21c0,32.49-22.51,46.65-43.75,46.65-23.77,0-42.11-17.42-42.11-45.19C87.12,60.26,106.36,43,130.69,43,155.91,43,173,61.35,173,88.21Zm-69.7.91c0,19.24,11.07,33.76,26.68,33.76,15.25,0,26.68-14.34,26.68-34.12,0-14.88-7.44-33.76-26.32-33.76S103.28,72.42,103.28,89.12Z"/>
            <path class="cls-1" d="M193.12,72.42c0-10.34-.18-19.24-.72-27.4h14l.55,17.24h.72C211.63,50.46,221.25,43,232,43a17.39,17.39,0,0,1,4.54.54V58.63a24.12,24.12,0,0,0-5.44-.55c-11.26,0-19.24,8.54-21.42,20.51a44.24,44.24,0,0,0-.73,7.45v46.82H193.12Z"/>
            <path class="cls-1" d="M276.06,19.79V45h22.87V57.18H276.06v47.37c0,10.89,3.09,17.06,12,17.06a35.3,35.3,0,0,0,9.26-1.09l.73,12c-3.09,1.27-8,2.18-14.16,2.18-7.44,0-13.43-2.36-17.24-6.72-4.54-4.72-6.17-12.52-6.17-22.87V57.18H246.84V45h13.62V24Z"/>
            <path class="cls-1" d="M318.53,132.86V57.18H306.19V45h12.34V40.84c0-12.34,2.73-23.59,10.17-30.67,6-5.81,14-8.17,21.42-8.17a37.08,37.08,0,0,1,13.61,2.54l-2.18,12.34a23.86,23.86,0,0,0-10.16-2c-13.62,0-17.06,12-17.06,25.41V45h21.23V57.18H334.33v75.68Z"/>
            <path class="cls-1" d="M447,88.21c0,32.49-22.51,46.65-43.74,46.65-23.78,0-42.11-17.42-42.11-45.19,0-29.41,19.24-46.65,43.56-46.65C430,43,447,61.35,447,88.21Zm-69.7.91c0,19.24,11.07,33.76,26.68,33.76,15.25,0,26.68-14.34,26.68-34.12,0-14.88-7.44-33.76-26.31-33.76S377.34,72.42,377.34,89.12Z"/>   
            <path class="cls-1" d="M467.18,4h16V132.86h-16Z"/>
            <path class="cls-1" d="M527.8,20.33c.19,5.45-3.81,9.8-10.16,9.8a9.49,9.49,0,0,1-9.62-9.8,9.74,9.74,0,0,1,10-10C524,10.35,527.8,14.71,527.8,20.33ZM510,132.86V45h16v87.84Z"/>
            <path class="cls-1" d="M632,88.21c0,32.49-22.51,46.65-43.75,46.65-23.77,0-42.1-17.42-42.1-45.19C546.14,60.26,565.38,43,589.7,43,614.92,43,632,61.35,632,88.21Zm-69.7.91c0,19.24,11.07,33.76,26.68,33.76,15.25,0,26.68-14.34,26.68-34.12,0-14.88-7.44-33.76-26.32-33.76S562.29,72.42,562.29,89.12Z"/>
                </g>
    </svg>
    ...
    <footer>
            <p class="titrefooter">CONTACT</p>
                ...
                <div class="gridcontainer">
                    ...
                    <div>
                        <form class="formulaire" action="/action_page.php">
                            <label for="fname">Nom</label>
                            <input class="cap" type="text" id="fname" name="firstname" placeholder="Votre nom..">

                                <p id="warning">⚠ Caps Lock is activated...</p>

                            <label for="lname">Mail</label>
                            <input class="cap" type="text" id="lname" name="lastname" placeholder="Votre mail...">
